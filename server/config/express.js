...
module.exports = function (app) {
  ...
  if ('production' === env) {
    app.use((0, _serveFavicon2.default)(_path2.default.join(_index2.default.root, 'client', 'favicon.ico')));
  ...
  if ('development' === env || 'test' === env) {
    app.use(_express2.default.static(_path2.default.join(_index2.default.root, '.tmp')));
    app.use(_express2.default.static(app.get('appPath')));
    app.use((0, _morgan2.default)('dev'));
